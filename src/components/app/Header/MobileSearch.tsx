...
export const MobileSearch = ({ handleClose }: MobileSearchProps) => {
  ...
  return (
    <div className="slide-in-from-right fixed top-0 right-0 left-0 z-[100] flex h-full w-full animate-in flex-col bg-white duration-300">
